...
az group deployment create --name "inventory-hub-eventhub-uksouth-td1" --resource-group "inventory-hub-uksouth-dev" --template-file createInventoryEventHub.json --parameters namespace_name="inventory-eventhub-uksouth-kafka1" region_name="westeurope"
