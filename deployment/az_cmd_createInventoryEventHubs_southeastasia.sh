...
az group deployment create --name "inventory-hub-eventhub-southeastasia-td1" --resource-group "inventory-hub-southeastasia-dev" --template-file createInventoryEventHub.json --parameters namespace_name="inventory-eventhub-southeastasia-kafka1" region_name="southeastasia"
