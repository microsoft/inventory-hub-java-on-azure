...
sed -i -e 's/connection/connectionStringSetting/g' target/azure-functions/*/Point-of-Sale/function.json
sed -i -e 's/connection/connectionStringSetting/g' target/azure-functions/*/Update-Inventory/function.json
